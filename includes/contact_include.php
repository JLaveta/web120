...
{
    global $toName,$toAddress,$website,$siteKey,$secretKey,$host,$port,$passwordSmtp,$usernameSmtp,$serverAddress,$serverName;
    ...
    if ($resp->isSuccess()):
        ...
        $bodyText =  $subject . PHP_EOL . PHP_EOL  . $postData; 
        
        email_handler($toAddress,$subject,$bodyText,$fromAddress,$usernameSmtp,$passwordSmtp,$host,$port,$serverAddress,$serverName);
...
function email_handler($toAddress,$subject,$bodyText,$fromAddress,$usernameSmtp,$passwordSmtp,$host,$port,$serverAddress,$serverName)
{   
    ...
    try {
        ...
        $mail->isSMTP();
        $mail->setFrom($serverAddress, $serverName);
